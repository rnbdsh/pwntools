...
from pwnlib.encoders.arm.alphanumeric import alphanum_byte
from pwnlib.encoders.arm.alphanumeric import ARM_Instructions
...
class builder:
   ...
   def enc_data_builder(self, input):
      ...
      p = 0
      for p, ab in enumerate(six.iterbytes(input)):
         b = ab & 0x0f
